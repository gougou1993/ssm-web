        ...
        <div class="row">
            <div class="col-md-12">
                <form id="menuEditForm">
                    <input id="parentcode" type="hidden" name="parentcode" value="<c:out value='${info.parentcode}' escapeXml='false' />" />
                    <input id="action" type="hidden" name="action" value="do" />
                    <div class="box box-info" style="margin-top:10px;">
                        <div class="box-header with-border">
                            <h3 class="box-title">新增菜单</h3></div>
                        <div class="box-body">
...
function submintForm() {
    ...
    $("#menuEditForm").ajaxSubmit({
        type: 'POST',
        url: 'se_menu_add_action.do',
        beforeSubmit: function() {
            if ($("#captionname").val() == '') {
                showFormWarm('captionname', '菜单名称不能为空！');
                return false;
            }
            showLoad();
        },
